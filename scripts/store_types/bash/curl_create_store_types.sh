...
# Creates all 2 store types via the Keyfactor Command REST API using curl.
#
...
# ---------------------------------------------------------------------------
# AzureAppGw — The Azure Tenant (directory) ID that owns the Service Principal.
# ---------------------------------------------------------------------------
create_store_type "AzureAppGw" '{
...
# ---------------------------------------------------------------------------
# AppGwBin — The Azure Tenant (directory) ID that owns the Service Principal.
# ---------------------------------------------------------------------------
create_store_type "AppGwBin" '{
